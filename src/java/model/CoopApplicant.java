...
public class CoopApplicant implements Serializable {
    ...
    public CoopApplicant(Integer applicantNo, String lastName, String firstName, String middleName, char gender, Date birthdate,
            String cityMun, String nationality, String occupation, Date applicationDate, String applicationStat, char civilStatus,
            String contactNumber, Date residentSince, String education, String street, String barangay) {
        this.applicantNo = applicantNo;
    ...
    public String getApplicationStat() {
        if (applicationStat == null) {
            applicationStat = "in-process";
        }
        return applicationStat;
    }

    public void setApplicationStat(String applicationStat) {
        if (this.applicationStat == null) {
            this.applicationStat = "in-process";
        }
        this.applicationStat = applicationStat;
    }
